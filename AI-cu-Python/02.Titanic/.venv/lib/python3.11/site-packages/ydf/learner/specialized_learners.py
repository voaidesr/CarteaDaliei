  ...
  Attributes:
    ...
    categorical_algorithm: How to learn splits on categorical attributes.
      ...
      - `ONE_HOT`: One-hot encoding. Find the optimal categorical split of the
        ...
        This method is available for comparison purposes for classification
        problems and generally performs worse than other alternatives.
...
class RandomForestLearner(generic_learner.GenericCCLearner):
  ...
  def hyperparameter_templates(cls) -> Dict[str, hyperparameters.HyperparameterTemplate]:
    ...
    Returns:
      Dictionary of the available templates
    """
    return {"better_defaultv1": hyperparameters.HyperparameterTemplate(name="better_default", version=1, description="A configuration that is generally better than the default parameters without being more expensive.", parameters={"winner_take_all" :True}), "better_defaultv2": hyperparameters.HyperparameterTemplate(name="better_default", version=2, description="A configuration that is generally better than the default parameters without being more expensive.", parameters={"winner_take_all" :False}), "benchmark_rank1v1": hyperparameters.HyperparameterTemplate(name="benchmark_rank1", version=1, description="Top ranking hyper-parameters on our benchmark slightly modified to run in reasonable time.", parameters={"winner_take_all" :True, "categorical_algorithm" :"RANDOM", "split_axis" :"SPARSE_OBLIQUE", "sparse_oblique_normalization" :"MIN_MAX", "sparse_oblique_num_projections_exponent" :1.0}), "benchmark_rank1v2": hyperparameters.HyperparameterTemplate(name="benchmark_rank1", version=2, description="Top ranking hyper-parameters on our benchmark slightly modified to run in reasonable time.", parameters={"winner_take_all" :False, "categorical_algorithm" :"RANDOM", "split_axis" :"SPARSE_OBLIQUE", "sparse_oblique_normalization" :"MIN_MAX", "sparse_oblique_num_projections_exponent" :1.0}), }
